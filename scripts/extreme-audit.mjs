...
if (m020.length > 1) note('migration-020 多文件需按指南顺序执行: ' + m020.join(', '));
...
try {
    ...
    if (String(pkg.version).startsWith('9.') || String(pkg.version).startsWith('10.')) ok('version ' + pkg.version);
    else note('version=' + pkg.version);
} catch (e) {
