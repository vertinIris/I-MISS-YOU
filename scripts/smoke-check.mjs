...
const symbolChecks = [
    ...
    { file: 'forum/js/forum.js', includes: ['safeMediaUrl', 'SecurityShield.init', 'submitBusy', 'openPostDetail', 'is_pinned', 'initForumRealmSelector'] },
    { file: 'js/snow-realm.js', includes: ['snowfluff-realm-sync', 'FORUM_COPY', 'BroadcastChannel'] },
    { file: 'forum/index.html', includes: ['stf-realm-dropdown', 'snow-realm.js'] },
