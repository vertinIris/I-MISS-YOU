...
- 改二创种子后本地构建：`npm run content:build`（或 `node scripts/build-forum-import.cjs`），输出到已跟踪的 `forum/js/forum-import-data.js`。
- 完整路径说明见 [`docs/CONTENT-PIPELINE.md`](../docs/CONTENT-PIPELINE.md)。
