...
- **资料优先级**：鸣潮官方 ＞ 同人共识补白 ＞ 项目原创（硬规则详见 `docs/WORLDVIEW.md`；术语机读源 `docs/worldview-glossary.json`）。
- **鸣潮**：索拉里斯后启示录 × 机能风 × 低饱和高级感；悲鸣/海蚀/声骸/调谐/频率意象；黑海岸清冷守望、黎那汐塔声骸之国、拉海洛虚质与星炬学院（以官方情报为准，维基仅交叉核对）。
- **飞行雪绒**：爱弥斯歌手化名；粉发墨镜夜航感；歌友会/电台/「I miss you」思念频道（官方角色设定 + 本站频道演绎，不得反写宇宙规则）。
- **星炬学院**：深空联合语境下的学院公共研讨场；毕业曲《星炬不熄》；蓝金星炬而非粉雪（官方企划文案优先；组织法理待核实处勿写死）。
