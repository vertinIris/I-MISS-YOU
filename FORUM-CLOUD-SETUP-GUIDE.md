...
> ⚠️ **过时提示（2026-08）**：本文为历史操作手册。以仓库内 **`db/migration-*.sql` + 当前前端代码** 为准；聊天请执行 `migration-023-forum-chat.sql`，勿再跑废弃的 `DEPRECATED-migration-020-forum-chat.sql`。置顶/楼中楼见 `migration-028-forum-pin-replies.sql`。现状摘要见 `docs/STATUS.md`。
