-- ██████ 已废弃（DEPRECATED）— 请勿执行本文件 ██████
--
-- 原因：本文件编号与 migration-020-forum-tables.sql 撞车，
--       按 019→020→021→022 顺序执行时会被漏跑，导致 forum_chat 始终未创建。
-- 替代：请执行 db/migration-023-forum-chat.sql
--       （内容等价，且补齐了本文件遗漏的 Realtime publication 注册）
-- 保留原因：留档，说明历史成因。可在确认 023 执行成功后删除本文件。
--
-- ████████████████████████████████████████████████████
